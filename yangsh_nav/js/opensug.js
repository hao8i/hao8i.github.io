...
var BaiduSuggestion = (function () {
        ...
        createSugOptions: function (S, R, Q, P) {
            return {
                ...
                getData: function (U) {
                    ...
                    T.src = "https://www.baidu.com/su?wd=" + encodeURIComponent(U) + "&p=3&cb=BaiduSuggestion.callbacks.give" + S;
                    T.id = "bdSug_script";
    ...
    function A() {
        ...
        L(".bdsug_copy", "margin:0;font-size:0px;color:#77c;text-decoration:none;padding:0 2px 0 16px;")
    }
    A();
